...
describe("Matrix Functions", () => {
  ...
  describe('Transform Operations', () => {
    ...
    test('Rotate A by V to equal expected', () => {
      const result = GLMath.Matrix.Transform.rotate(matrixA, Math.PI / 4, new Float32Array([1, 1, 0]));

      const expected =
        new Float32Array([0.8535534143447876, 0.1464466154575348, -0.5, 0,
  ...
  describe('Camera Functions', () => {
    test('Perspective Camera ', () => {
      ...
      const expected =
        new Float32Array([2.248223304748535, 0, 0, 0,
    ...
    test('LookAt matrix to equal expected', () => {
      const result = GLMath.Matrix.Camera.lookAt(new Float32Array([0, 0, 15]), new Float32Array([0, 0, -3]), new Float32Array([0, 1, 0]));
